  ...
  return (
    <div className="container xl:mx-[9rem] sm:mx-[0]">
      <div className="flex flex-col md:flex-row">
        <AdminMenu />
        <div className="md:w-3/4 p-3 flex-col">
          <div className="h-12">Crear Producto</div>
          ...
          <div className="p-3 ">
            <div className="flex flex-wrap ml-4">
              <div className="one">
                ...
                <input
                  type="text"
                  className="p-4 mb-3 w-[32rem] border rounded-lg bg-[#101011] text-white"
                  value={name}
            ...
            <div className="flex justify-between">
              <div>
                <label htmlFor="name block">Cantidad en Stock</label> <br />
                <input
                  type="text"
            ...
            <button
              ...
              className="text-white bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-800 shadow-lg shadow-pink-500/50 dark:shadow-lg dark:shadow-pink-800/80 font-bold rounded-lg text-sm px-10 py-2.5 text-center me-2 mb-2"
            >
              Crear
            </button>
          </div>
